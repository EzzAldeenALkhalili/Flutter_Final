...
class SportEducation extends StatefulWidget {
  const SportEducation({super.key});

  @override
  State<SportEducation> createState() => _SportEducationState();
}

class _SportEducationState extends State<SportEducation> {
  int _currentIndex = 0;
